defmodule MotmWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {MotmWeb.Layouts, :root}
  ...
  # scope "/api", MotmWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:motm, :dev_routes) do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: MotmWeb.Telemetry
    end
