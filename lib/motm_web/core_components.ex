defmodule MotmWeb.CoreComponents do
  @moduledoc """
  ...
  import MotmWeb.Gettext, warn: false
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MotmWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MotmWeb.Gettext, "errors", msg, opts)
    end
  end
